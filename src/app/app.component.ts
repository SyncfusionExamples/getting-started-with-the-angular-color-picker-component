...
import { ColorPickerModule, PaletteTileEventArgs, ColorPickerEventArgs } from '@syncfusion/ej2-angular-inputs';
import { addClass } from '@syncfusion/ej2-base';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, RouterOutlet, ColorPickerModule],
